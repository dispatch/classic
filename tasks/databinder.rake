...
DATABINDER_SELF=[DATABINDER_COMPONENTS, group("databinder-app","databinder-dispatch", "databinder-auth-components", "databinder-components", "databinder-models", :under => "net.databinder", :version => DB_VERS)]
